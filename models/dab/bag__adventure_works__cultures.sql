MODEL (
  ...
  description 'Hook viewpoint of cultures data: Lookup table containing the languages in which some AdventureWorks data is stored.',
  column_descriptions (
    ...
    _hook__reference__culture = 'Reference hook to culture reference',
    _pit_hook__reference__culture = 'Point-in-time hook that combines the primary hook with a validity timestamp'
  )
);
