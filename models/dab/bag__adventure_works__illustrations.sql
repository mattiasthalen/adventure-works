MODEL (
  ...
  description 'Hook viewpoint of illustrations data: Bicycle assembly diagrams.',
  column_descriptions (
    ...
    _pit_hook__reference__illustration = 'Point-in-time hook that combines the primary hook with a validity timestamp'
  )
);
