MODEL (
  ...
  description 'Bridge viewpoint of address_type reference data: Types of addresses stored in the Address table.',
  column_descriptions (
    _pit_hook__reference__address_type = 'Point-in-time hook for address_type reference',
    _hook__reference__address_type = 'Primary hook to address_type reference',
