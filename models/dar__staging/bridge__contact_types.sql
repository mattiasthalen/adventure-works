MODEL (
  ...
  description 'Bridge viewpoint of contact_type reference data: Lookup table containing the types of business entity contacts.',
  column_descriptions (
    _pit_hook__reference__contact_type = 'Point-in-time hook for contact_type reference',
    _hook__reference__contact_type = 'Primary hook to contact_type reference',
