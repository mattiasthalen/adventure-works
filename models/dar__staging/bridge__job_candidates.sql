MODEL (
  ...
  description 'Bridge viewpoint of job_candidate data: Résumés submitted to Human Resources by job applicants.',
  column_descriptions (
    ...
    _hook__job_candidate = 'Primary hook to job_candidate',
