MODEL (
  ...
  references (_pit_hook__product, _pit_hook__product_category, _pit_hook__product_list_price_history, _pit_hook__product_subcategory, _pit_hook__reference__product_model),
  description 'Bridge viewpoint of product_list_price_history data: Changes in the list price of a product over time.',
  column_descriptions (
    ...
    _hook__product_list_price_history = 'Primary hook to product_list_price_history',
...
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge._pit_hook__product_list_price_history,
    ...
    cte__bridge._hook__product_list_price_history,
    GREATEST(
  ...
  SELECT
    *,
    CONCAT_WS(
      ...
      _pit_hook__product_list_price_history::TEXT,
