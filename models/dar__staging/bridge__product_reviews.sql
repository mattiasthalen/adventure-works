MODEL (
  ...
  description 'Bridge viewpoint of product_review data: Customer reviews of products they have purchased.',
  column_descriptions (
    ...
    _hook__product_review = 'Primary hook to product_review',
