MODEL (
  ...
  description 'Bridge viewpoint of purchase order_line data: Individual products associated with a specific purchase order. See PurchaseOrderHeader.',
  column_descriptions (
    ...
    _hook__order_line__purchase = 'Primary hook to purchase order_line',
