...
cte__pit_lookup AS (
  SELECT
    ...
    bridge__purchase_order_headers._pit_hook__department,
    bridge__purchase_order_headers._pit_hook__order__purchase,
    bridge__purchase_order_headers._pit_hook__person__employee,
    bridge__purchase_order_headers._pit_hook__product,
    bridge__purchase_order_headers._pit_hook__product_category,
    bridge__purchase_order_headers._pit_hook__product_subcategory,
    bridge__purchase_order_headers._pit_hook__reference__product_model,
    bridge__purchase_order_headers._pit_hook__reference__shift,
    bridge__purchase_order_headers._pit_hook__reference__unit_measure,
