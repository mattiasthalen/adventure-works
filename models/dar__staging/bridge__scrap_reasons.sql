MODEL (
  ...
  references (_pit_hook__reference__scrap_reason),
  description 'Bridge viewpoint of scrap_reason reference data: Manufacturing failure reasons lookup table.',
  column_descriptions (
    _pit_hook__reference__scrap_reason = 'Point-in-time hook for scrap_reason reference',
    _hook__reference__scrap_reason = 'Primary hook to scrap_reason reference',
...
WITH cte__bridge AS (
  SELECT
    ...
    scrap_reason__record_loaded_at AS bridge__record_loaded_at,
    scrap_reason__record_updated_at AS bridge__record_updated_at,
    scrap_reason__record_valid_from AS bridge__record_valid_from,
    scrap_reason__record_valid_to AS bridge__record_valid_to,
    scrap_reason__is_current_record AS bridge__is_current_record
