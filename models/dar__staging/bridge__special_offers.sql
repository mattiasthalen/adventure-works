MODEL (
  ...
  description 'Bridge viewpoint of special_offer reference data: Sale discounts lookup table.',
  column_descriptions (
    _pit_hook__reference__special_offer = 'Point-in-time hook for special_offer reference',
    _hook__reference__special_offer = 'Primary hook to special_offer reference',
