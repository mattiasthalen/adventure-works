MODEL (
  ...
  description 'Bridge viewpoint of state_province reference data: State and province lookup table.',
  column_descriptions (
    ...
    _hook__reference__state_province = 'Primary hook to state_province reference',
