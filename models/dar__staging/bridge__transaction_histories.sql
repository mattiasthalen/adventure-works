MODEL (
  ...
  description 'Bridge viewpoint of transaction_history data: Record of each purchase order, sales order, or work order transaction year to date.',
  column_descriptions (
    ...
    _hook__transaction_history = 'Primary hook to transaction_history',
