MODEL (
  ...
  description 'Event viewpoint of business_entity_addresses data: Cross-reference table mapping customers, vendors, and employees to their addresses.',
  column_descriptions (
    peripheral = 'Name of the business_entity_addresses peripheral this event relates to',
