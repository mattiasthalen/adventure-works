MODEL (
  ...
  description 'Event viewpoint of contact_types data: Lookup table containing the types of business entity contacts.',
  column_descriptions (
    peripheral = 'Name of the contact_types peripheral this event relates to',
