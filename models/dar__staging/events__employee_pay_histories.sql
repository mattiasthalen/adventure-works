MODEL (
  ...
  description 'Event viewpoint of employee_pay_histories data: Employee pay history.',
  column_descriptions (
    peripheral = 'Name of the employee_pay_histories peripheral this event relates to',
...
WITH cte__bridge AS (
  ...
  FROM dar__staging.bridge__employee_pay_histories
),
cte__events AS (
  SELECT
