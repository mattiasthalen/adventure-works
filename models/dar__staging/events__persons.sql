MODEL (
  ...
  description 'Event viewpoint of persons data: Human beings involved with AdventureWorks: employees, customer contacts, and vendor contacts.',
  column_descriptions (
    peripheral = 'Name of the persons peripheral this event relates to',
