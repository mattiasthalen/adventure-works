MODEL (
  ...
  description 'Event viewpoint of product_list_price_histories data: Changes in the list price of a product over time.',
  column_descriptions (
    peripheral = 'Name of the product_list_price_histories peripheral this event relates to',
