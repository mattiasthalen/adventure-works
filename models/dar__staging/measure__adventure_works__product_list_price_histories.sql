...
WITH cte__source AS (
  ...
  SELECT
    _pit_hook__product,
    product_list_price_history__start_date AS measure_date,
  ...
  SELECT
    _pit_hook__product,
    product_list_price_history__end_date AS measure_date,
  ...
  SELECT
    _pit_hook__product,
    product_list_price_history__modified_date AS measure_date,
