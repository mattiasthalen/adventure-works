...
WITH cte__source AS (
  ...
  SELECT
    _pit_hook__person__sales,
    sales_territory_history__start_date AS measure_date,
  ...
  SELECT
    _pit_hook__person__sales,
    sales_territory_history__modified_date AS measure_date,
  ...
  SELECT
    _pit_hook__person__sales,
    sales_territory_history__end_date AS measure_date,
