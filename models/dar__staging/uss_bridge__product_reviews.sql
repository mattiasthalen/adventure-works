...
WITH cte__bridge AS (
  SELECT
    ...
    _hook__product,
    _hook__epoch__date,
    measure__product_reviews_review,
    measure__product_reviews_modified,
  ...
  LEFT JOIN dar__staging.measure__adventure_works__product_reviews USING (_pit_hook__product_review)
),
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge.measure__product_reviews_review,
    cte__bridge.measure__product_reviews_modified,
    GREATEST(
  ...
  SELECT
    *,
    CONCAT_WS(
      ...
      _pit_hook__product_review::TEXT,
