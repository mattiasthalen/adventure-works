...
WITH cte__bridge AS (
  SELECT
    ...
    measure__sales_person_quota_histories_modified,
  ...
  LEFT JOIN dar__staging.measure__adventure_works__sales_person_quota_histories USING (_pit_hook__person__sales)
),
