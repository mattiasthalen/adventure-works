...
WITH cte__bridge AS (
  SELECT
    ...
    measure__sales_territory_histories_modified,
  ...
  LEFT JOIN dar__staging.measure__adventure_works__sales_territory_histories USING (_pit_hook__person__sales)
),
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge.measure__sales_territory_histories_modified,
