...
WITH cte__bridge AS (
  SELECT
    ...
    _hook__product,
    _hook__epoch__date,
    measure__shopping_cart_items_modified,
  ...
  LEFT JOIN dar__staging.measure__adventure_works__shopping_cart_items USING (_pit_hook__shopping_cart_item)
),
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge.measure__shopping_cart_items_modified,
    GREATEST(
