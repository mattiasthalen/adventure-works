...
WITH cte__bridge AS (
  SELECT
    ...
    _hook__product,
    _hook__epoch__date,
    measure__transaction_histories_transaction,
    measure__transaction_histories_modified,
  ...
  LEFT JOIN dar__staging.measure__adventure_works__transaction_histories USING (_pit_hook__transaction_history)
),
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge.measure__transaction_histories_transaction,
    cte__bridge.measure__transaction_histories_modified,
    GREATEST(
