...
WITH cte__bridge AS (
  SELECT
    ...
    measure__work_order_routings_modified,
  ...
  LEFT JOIN dar__staging.measure__adventure_works__work_order_routings USING (_pit_hook__order_line__work)
),
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge.measure__work_order_routings_modified,
    GREATEST(
    ...
    LIST_HAS_ALL(
      ARRAY[True],
        ARRAY[
          ...
          uss_bridge__work_orders.bridge__is_current_record,
          ...
          uss_bridge__locations.bridge__is_current_record,
          uss_bridge__product_inventories.bridge__is_current_record
        ]
    ) AS bridge__is_current_record
  FROM cte__bridge
  LEFT JOIN dar__staging.uss_bridge__work_orders
  ...
  LEFT JOIN dar__staging.uss_bridge__locations
  ...
  LEFT JOIN dar__staging.uss_bridge__product_inventories
