...
WITH cte__bridge AS (
  ...
  LEFT JOIN dar__staging.measure__adventure_works__work_orders USING (_pit_hook__order__work)
),
cte__pit_lookup AS (
  SELECT
    ...
    cte__bridge.measure__work_orders_modified,
    GREATEST(
  ...
  LEFT JOIN dar__staging.uss_bridge__scrap_reasons
