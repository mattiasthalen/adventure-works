...
WITH staging AS (
  SELECT
    ...
    contact_type_id AS business_entity__contact_type_id,
    person_id AS business_entity__person_id,
  ...
  SELECT
    ...
    CONCAT('contact_type|adventure_works|', business_entity__contact_type_id) AS _hook__contact_type,
    CONCAT('person|adventure_works|', business_entity__person_id) AS _hook__person,
    *
  FROM validity
)
SELECT
  ...
  business_entity__contact_type_id::VARCHAR,
  business_entity__person_id::VARCHAR,
