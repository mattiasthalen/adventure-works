...
WITH staging AS (
  SELECT
    ...
    phone_number_type_id AS business_entity__phone_number_type_id,
  ...
  SELECT
    ...
    CONCAT('phone_number_type|adventure_works|', business_entity__phone_number_type_id) AS _hook__phone_number_type,
    *
  FROM validity
)
SELECT
  ...
  business_entity__phone_number_type_id::VARCHAR,
  business_entity__modified_date::VARCHAR,
  business_entity__phone_number::VARCHAR,
