...
WITH staging AS (
  SELECT
    ...
    product_model_id AS illustration__product_model_id,
  ...
  SELECT
    ...
    CONCAT('product_model|adventure_works|', illustration__product_model_id) AS _hook__product_model,
    *
  FROM validity
)
SELECT
  ...
  illustration__product_model_id::VARCHAR,
