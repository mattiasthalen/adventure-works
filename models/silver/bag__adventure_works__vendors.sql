...
SELECT
  ...
  business_entity__account_number::VARCHAR,
  business_entity__active_flag::VARCHAR,
  business_entity__credit_rating::VARCHAR,
  business_entity__modified_date::VARCHAR,
  business_entity__name::VARCHAR,
  business_entity__preferred_vendor_status::VARCHAR,
  business_entity__purchasing_web_service_url::VARCHAR,
