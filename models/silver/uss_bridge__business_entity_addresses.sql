...
cte__pit_lookup AS (
    ...
    LIST_HAS_ALL(
      ARRAY[True],
        ARRAY[
          ...
          uss_bridge__business_entity_contacts.bridge__is_current_record::BOOL,
          uss_bridge__address_types.bridge__is_current_record::BOOL
        ]
    ) AS bridge__is_current_record
  FROM cte__bridge
  LEFT JOIN silver.uss_bridge__business_entity_contacts
  ...
  LEFT JOIN silver.uss_bridge__address_types
